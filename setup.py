...
setup(
    ...
    zip_safe=False,
    install_requires=['numpy', 'scipy', 'pandas', 'scikit-image', 'gisttools @ git+https://github.com/liedllab/gisttools.git', 'plyfile', 'matplotlib>=3.7', 'pdb2pqr>=3', 'biopython', 'rdkit'],
