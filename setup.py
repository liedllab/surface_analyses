...
setup(
    ...
    zip_safe=False,
    install_requires=['numpy', 'scipy', 'pandas', 'scikit-image', 'gisttools @ git+https://github.com/liedllab/gisttools.git', 'plyfile', 'matplotlib>=3.7', 'anarci @ git+https://github.com/oxpig/ANARCI', 'biopython', 'rdkit'],
